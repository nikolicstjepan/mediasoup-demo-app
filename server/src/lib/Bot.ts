...
class Bot {
    ...
    constructor({ transport, dataProducer }: { transport: Transport; dataProducer: DataProducer }) {
    ...
    async handlePeerDataProducer({ dataProducerId, peer }: { dataProducerId: string; peer: Peer }) {
